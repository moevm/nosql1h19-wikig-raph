...
<nav class="navbar navbar-dark bg-dark">
    <form class="form-inline my-2 my-lg-0 ml-auto" action="/admin">
        <button class="btn btn-success my-2 my-sm-0" type="submit">Admin</button>
    </form>
</nav>
<div class="container">
...
<hr>
<div class=w3-row">
    <div class="info w3-col l3 m8 s10">
